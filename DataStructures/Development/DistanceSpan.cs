...
namespace ASTITransportation.Development
{
    /**
...
**/
    ...
    namespace ScrimpNet.Core.I18n
    {
        ...
        public struct DistanceSpan : IFormattable
        {
            ...
            static DistanceSpan()
            {
                _shortAbbrev = new string[] { "km", "m", "dm", "cm", "mm", "mi.", "yd.", "ft.", "in.", "nm." };
                _nameSingular = new string[] { "kilometer", "meter", "decimeter", "centimeter", "millimeter", "mile", "yard", "foot", "inch", "nmile" };
                _namePlural = new string[] { "kilometers", "meters", "decimeters", "centimeters", "millimeters", "miles", "yards", "feet", "inches", "nmiles" };
            }
            ...
            public double TotalDecimeters
            {
                ...
                set
                {
                    _meters = ToMetric(_meters, DistanceType.Decimeter);
                }
            ...
            public static double ToMetric(double value, DistanceType inputDistanceType)
            {
                ...
                switch (inputDistanceType)
                {
                    ...
                    case DistanceType.Meter: _meters = value;
                        break;
                    case DistanceType.Decimeter: _meters = value / 10D;
                        break;
            ...
            public static double FromMetric(double meters, DistanceType outputType)
            {
                ...
                switch (outputType)
                {
                    ...
                    case DistanceType.Meter: _retval = meters;
                        break;
                    case DistanceType.Decimeter: _retval = meters * 10D;
                        break;
            ...
            /// <summary>
            /// Create a new distance span from an centimeter value
            /// </summary>
            /// <param name="inches">Centimeters for this distance</param>
            /// <returns>New DistanceSpan</returns>
            public static DistanceSpan FromCentimeters(double centimeters) { return new DistanceSpan(centimeters, DistanceType.Centimeter); }

            /// <summary>
            /// Create a new distance span from an decimeter value
            /// </summary>
            /// <param name="inches">Decimeters for this distance</param>
            /// <returns>New DistanceSpan</returns>
            public static DistanceSpan FromDecimeter(double decimeters) { return new DistanceSpan(decimeters, DistanceType.Decimeter); }
            ...
            public string ToString(string format, IFormatProvider formatProvider)
            {
                ...
                switch (aParts[1])
                {
                    ...
                    case "DM": return string.Format(formatProvider, sFormat + " " + DistanceSpan.Name(this, DistanceType.Decimeter), TotalDecimeters);
                    case "dm": return string.Format(formatProvider, sFormat + " " + DistanceSpan.Abbreviation(DistanceType.Decimeter), TotalDecimeters);
