...
namespace ASTITransportation.Snmp.Transport
{
    ...
    class UdpTransport
    {
        ...
        /// </summary>
        public UdpTransport(SnmpMessenger messengerSession)
        {
        ...
        public UdpTransport(SnmpMessenger messengerSession, UdpClient existingClient)
        {
            this._session = messengerSession;
            this._socket = existingClient.Client;
        }
